...
export default function HomeScreen() {
  ...
  async function addChannel() {
    ...
    try {
      ...
      if (!item) {
        Alert.alert('Not found', 'Could not find that channel. Try the full @handle.')
        setLoading(false)
        return
      }
    ...
    <View style={styles.container}>
      ...
      {fetching ? (
        ...
        <View style={styles.empty}>
          ...
          <Text style={styles.emptySub}>Add a YouTube @handle above to get started</Text>
        </View>
      ) : (
        <FlatList
          data={channels}
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              <View style={styles.channelInfo}>
                <Text style={styles.channelName}>{item.title || item.handle}</Text>
